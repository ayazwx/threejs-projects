...
let objToRender = 'Lamborghini-Aventador-Sport'
...
// const texture = textureLoader.load('models/textures/building_016_c.tga');
// const material = new THREE.MeshBasicMaterial({ map: texture });
// scene.background = material;
document.getElementById('container3D').style.backgroundColor = 'white'
